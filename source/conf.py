...
extensions = ['sphinx.ext.todo', 'sphinx.ext.pngmath', 'sphinx.ext.mathjax','sphinx.ext.autodoc','sphinx.ext.napoleon']
...
html_static_path = ['source/theme/static']
